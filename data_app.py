...
# User Login and QR Code Generation
...
# 2FA Verification and JWT Token Generation
...
def verify_2fa():
    ...
    access_token = create_access_token(identity=str(user.id), expires_delta=datetime.timedelta(minutes=10))
